...
<head>
    <meta charset="UTF-8">
    <title>Лечение зубов — Стоматологическая клиника Жемчуг</title>
...
<table border="0" width="900" cellpadding="5" cellspacing="0" align="center">
    <tr>
        ...
        <td valign="top">
            <h2 align="center">Лечение зубов</h2>
            
            <h3 class="product-heading">Краткое описание товара</h3>
            <img src="img/product1.jpg" alt="Лечение зубов" width="220" class="product-image" onclick="openImage(this.src)">
            <p class="product-short-desc">Профессиональное лечение зубов любой сложности с применением современных технологий и материалов. Безболезненно, быстро, качественно.</p>
            ...
            <div class="product-full-desc">
                <p>Наша клиника предлагает полный спектр услуг по лечению зубов. Мы применяем современные методики и материалы, что позволяет сделать процесс лечения комфортным и безболезненным.</p>
                <p>Наши специалисты имеют большой опыт работы и постоянно совершенствуют свои навыки. Мы используем только качественные материалы и оборудование, что гарантирует долговечность и надежность результата.</p>
                <p>Кроме того, мы предоставляем гарантию на все виды работ. Вы можете быть уверены в качестве наших услуг!</p>
            </div>
            <hr>
        </td>
