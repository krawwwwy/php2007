...
<head>
    <meta charset="UTF-8">
    <title>добавление 2 — Стоматологическая клиника Жемчуг</title>
...
<table border="0" width="900" cellpadding="5" cellspacing="0" align="center">
    <tr>
        ...
        <td valign="top">
            <h2 align="center">добавление 2</h2>
            
            <h3 class="product-heading">Краткое описание товара</h3>
            <img src="img/product_placeholder_1748341021.jpg" alt="добавление 2" width="220" class="product-image" onclick="openImage(this.src)">
            <p class="product-short-desc">Рекомендации по заполнению:</p>
            
            <h3 class="product-heading">Характеристики товара</h3>
            <ul class="product-features"><li>Профессиональное обслуживание</li>
...
<li>Опытные врачи</li>
            ...
            <div class="product-full-desc"><p>В поле Описание услуги первый абзац будет использован как краткое описание</p>
<p>Короткие предложения с точкой в конце будут использованы как характеристики услуги</p>
<p>Разделяйте абзацы пустой строкой для лучшей структуры текста</p>
<p>добавлени 2</p>
</div>
            <hr>
        </td>
