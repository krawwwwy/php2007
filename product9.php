...
<head>
    <meta charset="UTF-8">
    <title>11213 — Стоматологическая клиника Жемчуг</title>
...
<table border="0" width="900" cellpadding="5" cellspacing="0" align="center">
    <tr>
        ...
        <td valign="top">
            <h2 align="center">11213</h2>
            
            <h3 class="product-heading">Краткое описание товара</h3>
            <img src="img/product1748341045.jpg" alt="11213" width="220" class="product-image" onclick="openImage(this.src)">
            <p class="product-short-desc">213312</p>
...
<li>Опытные врачи</li>
            ...
            <div class="product-full-desc"><p>213312</p></div>
            <hr>
        </td>
