...
<head>
    <meta charset="UTF-8">
    <title>Отбеливание — Стоматологическая клиника Жемчуг</title>
...
<table border="0" width="900" cellpadding="5" cellspacing="0" align="center">
    <tr>
        ...
        <td valign="top">
            <h2 align="center">Отбеливание</h2>
            
            <h3 class="product-heading">Краткое описание товара</h3>
            <img src="img/tooth-whitening.jpg" alt="Отбеливание" width="220" class="product-image" onclick="openImage(this.src)">
            <p class="product-short-desc">Профессиональное отбеливание зубов по современным технологиям для достижения белоснежной улыбки. Эффективно, безопасно, долговечный результат.</p>
            
            <h3 class="product-heading">Характеристики товара</h3>
            <ul class="product-features">
                <li>Различные системы отбеливания</li>
                <li>Безопасные технологии</li>
                <li>Видимый результат уже после первой процедуры</li>
                <li>Защита эмали при процедуре</li>
                <li>Консультация до и после процедуры</li>
            </ul>
            
            <h3 class="product-heading">Подробное описание товара</h3>
            <div class="product-full-desc">
                <p>В нашей клинике вы можете воспользоваться услугой профессионального отбеливания зубов. Мы применяем только проверенные и безопасные методики, которые не повреждают эмаль и обеспечивают долговременный результат.</p>
                <p>Перед процедурой врач проводит осмотр и консультацию, чтобы определить оптимальную систему отбеливания именно для ваших зубов. После процедуры вы получите рекомендации по уходу за зубами для сохранения эффекта на длительное время.</p>
                <p>Мы предлагаем различные варианты отбеливания: офисное отбеливание с использованием профессиональных систем, домашнее отбеливание под контролем врача, комбинированные методики. Эффект сохраняется от 1 года до 3 лет в зависимости от индивидуальных особенностей и соблюдения рекомендаций.</p>
            </div>
            <hr>
        </td>
