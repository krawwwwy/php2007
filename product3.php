...
<head>
    <meta charset="UTF-8">
    <title>Имплантация — Стоматологическая клиника Жемчуг</title>
...
<table border="0" width="900" cellpadding="5" cellspacing="0" align="center">
    <tr>
        ...
        <td valign="top">
            <h2 align="center">Имплантация</h2>
            
            <h3 class="product-heading">Краткое описание товара</h3>
            <img src="img/product3.jpg" alt="Имплантация" width="220" class="product-image" onclick="openImage(this.src)">
            <p class="product-short-desc">Имплантация зубов — современный метод восстановления зубного ряда. Мы используем только сертифицированные имплантаты ведущих производителей.</p>
            
            <h3 class="product-heading">Характеристики товара</h3>
            <ul class="product-features">
                <li>Надежные имплантаты</li>
                <li>Компьютерное планирование</li>
            ...
            <div class="product-full-desc">
                <p>Имплантация — это хирургическая процедура установки титанового штифта в челюстную кость для замены корня утраченного зуба. На этот штифт впоследствии устанавливается коронка, которая по внешнему виду и функциональности не уступает естественному зубу.</p>
                <p>В нашей клинике вы можете пройти полный цикл имплантации: от предварительной консультации и компьютерного моделирования до установки имплантата и протезирования. Мы используем имплантаты ведущих мировых производителей, которые отличаются высоким качеством и надежностью.</p>
                <p>Процедура проводится под местной анестезией и абсолютно безболезненна. В зависимости от сложности случая, имплантация может занять от 30 минут до 2 часов. После установки имплантата требуется период приживления (от 2 до 6 месяцев), после чего устанавливается постоянная коронка.</p>
            </div>
            <hr>
        </td>
