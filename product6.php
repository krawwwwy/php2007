...
<head>
    <meta charset="UTF-8">
    <title>Рентгенология — Стоматологическая клиника Жемчуг</title>
...
<table border="0" width="900" cellpadding="5" cellspacing="0" align="center">
    <tr>
        ...
        <td valign="top">
            <h2 align="center">Рентгенология</h2>
            
            <h3 class="product-heading">Краткое описание товара</h3>
            <img src="img/banner3.jpg" alt="Рентгенология" width="220" class="product-image" onclick="openImage(this.src)">
            <p class="product-short-desc">Диагностика состояния зубов и челюстей с помощью современного рентгенологического оборудования. Точная визуализация, минимальная лучевая нагрузка.</p>
            
            <h3 class="product-heading">Характеристики товара</h3>
            <ul class="product-features">
                <li>Цифровые технологии</li>
                <li>Минимальная доза облучения</li>
                <li>Высокая точность диагностики</li>
                <li>Различные виды снимков</li>
                <li>Быстрое получение результатов</li>
            </ul>
            
            <h3 class="product-heading">Подробное описание товара</h3>
            <div class="product-full-desc">
                <p>Наша клиника оснащена современным рентгенологическим оборудованием, которое позволяет проводить различные виды диагностики состояния зубов и челюстей с минимальной лучевой нагрузкой.</p>
                <p>Мы предлагаем следующие виды рентген-диагностики:</p>
                <ul>
                    <li><strong>Прицельные снимки</strong> – для диагностики отдельных зубов</li>
                    <li><strong>Панорамные снимки (ОПТГ)</strong> – для обзора всей челюстно-лицевой области</li>
                    <li><strong>Компьютерная томография</strong> – для трехмерной визуализации</li>
                </ul>
                <p>Рентген-диагностика необходима для точного определения состояния зубов и костной ткани, выявления скрытых патологий, планирования лечения и контроля его результатов. Все исследования проводятся с соблюдением норм радиационной безопасности.</p>
                <p>По результатам исследования вы получите квалифицированную консультацию специалиста и, при необходимости, рекомендации по дальнейшему лечению.</p>
            </div>
            <hr>
        </td>
