...
<head>
    <meta charset="UTF-8">
    <title>Протезирование — Стоматологическая клиника Жемчуг</title>
...
<table border="0" width="900" cellpadding="5" cellspacing="0" align="center">
    <tr>
        ...
        <td valign="top">
            <h2 align="center">Протезирование</h2>
            
            <h3 class="product-heading">Краткое описание товара</h3>
            <img src="img/product2.jpg" alt="Протезирование" width="220" class="product-image" onclick="openImage(this.src)">
            <p class="product-short-desc">Качественное протезирование зубов с использованием современных материалов. Индивидуальный подход, эстетичный результат, долговечность конструкций.</p>
            
            <h3 class="product-heading">Характеристики товара</h3>
            <ul class="product-features">
                <li>Широкий выбор материалов</li>
                <li>Современные технологии</li>
                <li>Точность и комфорт</li>
                <li>Гарантия на все виды работ</li>
            </ul>
            
            <h3 class="product-heading">Подробное описание товара</h3>
            <div class="product-full-desc">
                <p>Наша клиника предлагает различные виды протезирования зубов: съемные, несъемные и условно-съемные конструкции. Мы используем только качественные материалы, что гарантирует долговечность и эстетичность результата.</p>
                <p>Процесс протезирования начинается с консультации специалиста, который подберет оптимальный вариант, исходя из ваших потребностей и особенностей. Мы учитываем все факторы: от состояния зубов и десен до вашего образа жизни и бюджета.</p>
                <p>Современное оборудование и опыт наших врачей позволяют добиться максимально естественного вида протезов, которые будут удобны в использовании и прослужат долгие годы.</p>
            </div>
            <hr>
        </td>
